    ...
    describe('RSS Feeds', function() {
         ...
         */
         for (let feedName of allFeeds) {
             (function (name) {
         it('Each feed has a name and not empty', function() {
...
describe('The menu', function() {
         ...
         */
         var e = menu[0].getAttribute('class');

         it('menu element is hidden by default', function() {
             expect(e).toEqual('menu-hidden');
          ...
          */
          ...
          it('menu visibility change on click', function() {
            $('.menu-icon-link').trigger('click');
              var visibel = $('body').hasClass('menu-hidden');
            expect(visibel).toBe(false);
            $('.menu-icon-link').trigger('click');
              var notVisible = $('body').hasClass('menu-hidden');
...
describe('Initial Entries', function() {
       ...
       beforeEach(function(done) {
         ...
         it ('there is at least one entry element within feed', function(){
